    ...
    return (
        ...
        <AnimatePresence mode="wait">
            ...
            <motion.div
                ...
                className="relative w-full max-w-md aspect-square pr-0 p-4"
            >
                <div className="relative w-full h-full  overflow-hidden shadow-2xl border-3 border-white/10">
                    <Image
                        src="/coolpick.jpeg" 
                        alt="The Secret"
                        fill
                ...
                <button 
                    onClick={() => { setShowImage(false); setCount(0); }}
