import { TMDB_IMAGE_BASE, type InterisTop4Item } from "@/server/interis";
  ...
  return (
    <div className="flex flex-col gap-2">
      {items.map((item) => (
        <article
          key={item.slot}
          className="group relative flex items-start gap-4 border border-[rgba(64,61,82,0.7)] bg-[rgba(31,29,46,0.5)] px-5 py-4"
        >
