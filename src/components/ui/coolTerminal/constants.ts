...
export const SNAKE_TICK_MS = 85;
// JetBrains Mono char height/width ratio ≈ 2.25 at leading-[1.35] — vertical ticks compensate
export const SNAKE_TICK_MS_VERTICAL = 130;
