...
import { Briefcase, FolderGit2, Heart, Menu, Terminal, User } from "lucide-react";
...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <details className="absolute right-5 md:hidden">
        <summary
          aria-label="Toggle navigation"
          className="focus-ring list-none cursor-pointer p-1 text-[rgba(255,255,255,0.4)]"
        >
          <Menu size={18} />
        </summary>
