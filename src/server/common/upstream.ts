...
import { graphqlRequest, type GraphqlRequestOptions } from "@/server/common/graphql";
...
export interface GetOptions {
  ...
  cacheKey?: string;
  /** Gate the cache write — e.g. `(r) => r.ok` to not pin a failed fetch. */
  cacheWhen?: (result: ServiceResult<unknown>) => boolean;
}
